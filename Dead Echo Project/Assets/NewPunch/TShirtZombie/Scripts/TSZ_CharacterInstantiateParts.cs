...
public class TSZ_CharacterInstantiateParts : MonoBehaviour
{
	private int bodyTyp;
	private int topTyp;
    ...
    void Start ()
	{
        ...
        pref.gameObject.GetComponent<TSZ_CharacterCustomizeParts> ().charCustomize (bodyTyp, topTyp, bottomTyp, eyesTyp);
